...
SRC += usb/usb.c usb/max3421e.c usb/usb-max3421e.c usb/usbdebug.c usb/timer.c usb/hub.c usb/xboxusb.c usb/hid.c usb/hidparser.c usb/hidquirks.c usb/joymapping.c usb/joystick.c
