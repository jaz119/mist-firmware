...
SRC += main.c firmware.c fpga.c syscalls.c menu.c osd.c user_io.c user_io_hid.c settings.c hdd.c data_io.c idxfile.c ini_parser.c cue_parser.c mist_cfg.c arc_file.c font.c utils.c serial_sink.c diskio.c storage_control.c
...
SRC += support/8bit/core.c support/8bit/idx_files.c support/pcecd.c support/neocd.c support/snes.c support/8bit/menu.c support/8bit/menu_info.c
